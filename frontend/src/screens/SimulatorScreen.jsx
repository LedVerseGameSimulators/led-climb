      ...
      if (hasRfidCard) {
        await fetch(`${API_URL}/save-score`, {
          ...
          body: JSON.stringify({
            ...
            level: levelLabel,              // FE display → Climb DB → RFID LB
      ...
      <div className="screen">
        <div className="card">
          ...
          <p style={{ textAlign: 'center', marginTop: '20px' }}>
            Power Climb - Level {formatLevelLabel(config.playMode, config.level)} ({config.difficulty})
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div className="simulator-container">
      <div className="simulator-header">
        <div>
          <h2 style={{ margin: 0 }}>
            Power Climb — Level {currentLevelLabel}
          </h2>
      ...
      <div className="simulator-stage">
        ...
        {!phaseReady && (
          <div className="boot-banner" aria-live="polite">
            ...
            <p className="boot-banner-sub">
              Power Climb · Level {formatLevelLabel(config.playMode, config.level)}
            </p>
          </div>
        )}
        ...
        {overlayVisible && !isOver && phase === 'countdown' && countdownLabel && (
          <div className="phase-overlay countdown-overlay" aria-live="polite">
            ...
            <p className="countdown-meta">Level {currentLevelLabel}</p>
          </div>
        )}
