"""
Climb hardware diagnostic.
Run from led-climb/games/: python test_hardware.py

Sends all-green to the floor for 3s, then reads sensors for 5s.
Expected: 6x33 floor lights up green; stepping on a tile prints a PRESS line.
"""
import sys
import os
import time
...
DEFAULT_ROWS, DEFAULT_COLS = 6, 33


def main():
    print("=== Climb Hardware Test ===")
